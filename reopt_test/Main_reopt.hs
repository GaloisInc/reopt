...
mkElfMem LoadBySection e = either fail (return . snd) $ memoryForElfSections Rela64 e
mkElfMem LoadBySegment e = either fail (return . snd) $ memoryForElfSegments Rela64 e
