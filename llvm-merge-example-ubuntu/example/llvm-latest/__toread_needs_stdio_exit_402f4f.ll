...
define { i64, i64, <2 x double> } @F402f4f(i64 %a0, i64 %a1, i64 %a2, <2 x double> %a3) {
entry:
  %r0 = bitcast <2 x double> %a3 to i128
  br label %block_402f4f
block_402f4f:
  ; r0 := (alloca 0x0 :: [64])
  %r1 = alloca i8, i64 0
  ...
  %r5 = call { i64, i64, <2 x double> } @F402eb4(i64 %a0, i64 %a1, i64 %a2, <2 x double> %r4)
